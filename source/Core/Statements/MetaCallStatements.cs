...
{
    public partial class MetaCallNodeStatement : MetaStatements
    {
        ...
        private MetaCallNodeStatement m_FrontCallNode = null;
        ...
        private List<MetaCallStatements> m_MetaArrayCallNodeList = new List<MetaCallStatements>();
        ...
        protected MetaCallNodeStatement()
        { }
        public MetaCallNodeStatement(FileMetaCallNode fmcn1, FileMetaCallNode fmcn2, MetaClass mc, MetaBlockStatements mbs, MetaCallLink mcl)
        {
        ...
        public void SetFrontCallNode(MetaCallNodeStatement mcn)
        {
            m_FrontCallNode = mcn;
        }
            ...
            else
            {
                ...
                if (mv != null)
                {
                    ...
                    if (mv.isArray)             //Array<int> arr = {1,2,3}; 这个arr[0]就是mv
                    {
                        ...
                        {
                            MetaCallNodeStatement fmcn1 = m_MetaArrayCallNodeList[0].finalMetaCallNode;
    ...
    public partial class MetaCallStatements : MetaStatements
    {
        ...
        private MetaClass m_OwnerMetaClass = null;
        private MetaCallNodeStatement m_FinalMetaCallNode = null;
        private MetaCallNodeStatement m_FirstNode = null;

        private List<MetaCallNodeStatement> m_MetaCallNodeStatements = new List<MetaCallNodeStatement>();
        ...
        public MetaCallNodeStatement finalMetaCallNode => m_FinalMetaCallNode;
        public List<MetaCallNodeStatement> callNodeList
        {
            get
            {
                List<MetaCallNodeStatement> list = new List<MetaCallNodeStatement>();
        ...
        {
            MetaCallNodeStatement frontMetaNode = null;
            if (m_FileMetaCallLink.callNodeList.Count > 0)
            {
                FileMetaCallNode fmcn = m_FileMetaCallLink.callNodeList[0];
                //m_FirstNode = new MetaCallNodeStatement(null, fmcn, m_OwnerMetaClass, m_OwnerMetaBlockStatements, this);
            ...
            for (int i = 1; i < m_FileMetaCallLink.callNodeList.Count; i = i + 2)
            {
                ...
                //var fmn = new MetaCallNodeStatement(cn1, cn2, m_OwnerMetaClass, m_OwnerMetaBlockStatements, this);
                //fmn.isFirst = false;
        ...
        {
            var allowUseConst = new AllowUseConst(_useConst);
        ...
        {
            if (m_FileMetaCallLink != null)
            {
                return m_FileMetaCallLink.callNodeList[0].token.sourceBeginLine;
            }
            return 0;
        }
        public int CalcParseLevel(int level)
