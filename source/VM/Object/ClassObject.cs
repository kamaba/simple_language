...
namespace SimpleLanguage.VM
{
    public class ClassObject : SObject
    {
        ...
        /// <summary>按成员下标从 <see cref="memberData"/> 解析到 <paramref name="RuntimeValue"/>（引用型槽位为对象指针 Id，见 RuntimeObject）。</summary>
        ...
        /// <summary>从实例成员读取到 <paramref name="RuntimeValue"/>；与 <see cref="m_MemberData"/> 一致（同 <see cref="RuntimeType.GetStaticMemberVariableSValue"/> 静态侧）。</summary>
