...
public class GZip extends Object
{
    ...
    public static ByteBuf compress( ByteStream src ) throws
    {
        var all = src.readAll()
    ...
    public static void compressTo( ByteStream dst, ByteBuf src ) throws
    {
    ...
    public static void decompressTo( ByteStream dst, ByteBuf src ) throws
    {
