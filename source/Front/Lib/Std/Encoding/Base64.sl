...
public class Base64 extends Object
{
    ...
    public static ByteBuffer encode( ByteBuffer src ) throws
    {
    ...
    # 时抛 DecodeFailed
    public static ByteBuffer decode( ByteBuffer src ) throws
    {
        if SystemByteBufferIsReleased( src.handle )
        {
            throw BufferError.Released
    ...
    public static ByteBuffer encode( string src ) throws
    {
    ...
    # 编码整个字节数组，返回新缓冲
    public static ByteBuffer encode( UInt8Array src ) throws
    {
    ...
    public static string encodeToString( ByteBuffer src ) throws
    {
    ...
    # 解码并按 UTF-8 还原为原始文本（内嵌 NUL 截断语义同 ByteBuffer.toString）
    public static string decodeString( ByteBuffer src ) throws
    {
    ...
    # 解码并导出为字节数组
    public static UInt8Array decodeBytes( ByteBuffer src ) throws
    {
        var b = Base64.decode( src )
        var bytes = b.toArray()
        b.release()
    ...
    public static ByteBuffer encode( ByteStream src ) throws
    {
        var all = src.readAll()
    ...
    public static void encodeTo( ByteStream dst, ByteBuffer src ) throws
    {
    ...
    public static void decodeTo( ByteStream dst, ByteBuffer src ) throws
    {
