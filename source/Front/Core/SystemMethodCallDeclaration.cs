...
namespace SimpleLanguage.Core
{
    ...
    public static class SystemMethodCallDeclarationRegistry
    {
        private static readonly Dictionary<ESystemMethodCall, SystemMethodCallDeclaration> s_Decl = new Dictionary<ESystemMethodCall, SystemMethodCallDeclaration>
        {
            ...
            { ESystemMethodCall.SystemConvertInt8, new SystemMethodCallDeclaration(ESystemMethodCall.SystemConvertInt8, CoreMetaClassManager.uint8MetaClass, false, CoreMetaClassManager.objectMetaClass, CoreMetaClassManager.int32MetaClass) },
            { ESystemMethodCall.SystemConvertSInt8, new SystemMethodCallDeclaration(ESystemMethodCall.SystemConvertSInt8, CoreMetaClassManager.int8MetaClass, false, CoreMetaClassManager.objectMetaClass, CoreMetaClassManager.int32MetaClass) },
