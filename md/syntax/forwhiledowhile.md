...
for v in 1..10
{
    ...
    Console.print( "v=$v v.value = &v.value index=$v.index ");
}
```
...
ProjectEnter
{
    static Main()
    {
        ...
        for v in 1..3
        {
            Console.print("v=$v index=$v.index");
        }
        #输入结果
        #>>v=1 index=0
        #>>v=2 index=1
        ...
        for i = 0, i < 2, i++
        {
            Console.print("v=$i");  #条件迭代没有index值
        }
        #输入结果
        #>>v=0
        #>>v=1
